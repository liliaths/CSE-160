...
class Vector3 {
  ...
  static dot(other1, other2) {
      // Insert your code here.
      const element1 = other1.elements;
      const element2 = other2.elements;
      let d = element1[0] * element2[0] + element1[1] * element2[1] + element1[2] * element2[2]; // Modify this line to calculate this vector's magnitude.
  ...
  static cross(other1, other2) {
      ...
      const x = element1[1] * element2[2] - element1[2] * element2[1];
      const y = element1[2] * element2[0] - element1[0] * element2[2];
      const z = element1[0] * element2[1] - element1[1] * element2[0];
  ...
  magnitude() {
      ...
      let m = Math.sqrt(elements[0] * elements[0] + elements[1] * elements[1] + elements[2] * elements[2]); // Modify this line to calculate this vector's magnitude.
